...
// <workflow-map>
// Workflow : Stage 1 - Test
// Nodes   : 41  |  Connections: 43
//
// NODE INDEX
// ──────────────────────────────────────────────────────────────────
...
export class Stage1TestWorkflow {
    // =====================================================================
...
return $input.item;`,
    ...
    @node({
        id: '45cbb278-d2d2-4d16-9123-602bf928ab38',
        webhookId: 'd9dce2b8-13e7-45c8-b158-26384e0741ea',
        name: 'Webhook',
...
return {
  json: {
    ...
    defineRouting() {
        ...
        this.Webhook.out(0).to(this.InputLerClienteBdInput.in(0));
